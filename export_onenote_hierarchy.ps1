...
Write-Host ""
Write-Host "  2. SCP to Cerebro (run from Mac):"
Write-Host "       scp '/Users/james/Dropbox/Business/OneNote/01_Raw_Audit/{Notebook}/rollup_groups.json' \"
Write-Host "           lab-user@10.254.254.48:Onenote-archivist/onenote_audit/01_Raw_Audit/{Notebook}/"
Write-Host ""
